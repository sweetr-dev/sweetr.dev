        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="grid md:grid-cols-3 gap-8 md:gap-6 lg:gap-16 text-center">
            ...
            <div>
              ...
              <h3 className="font-inter-tight font-semibold text-zinc-800 mb-1">Personal</h3>
              <p className="text-sm text-zinc-500">We can help you choose the right plan for your team.</p>
            </div>
            {/* Item #2 */}
            <div>
              <div className="w-8 h-8 bg-slate-50 border border-zinc-200 rounded-md inline-flex items-center justify-center mb-3">
              ...
              <h3 className="font-inter-tight font-semibold text-zinc-800 mb-1">Metrics</h3>
              <p className="text-sm text-zinc-500">We can help you choose the right plan for your team.</p>
            </div>
            {/* Item #3 */}
            <div>
              ...
              <h3 className="font-inter-tight font-semibold text-zinc-800 mb-1">Flexible</h3>
              <p className="text-sm text-zinc-500">We can help you choose the right plan for your team.</p>
            </div>
          </div>
        </div>
