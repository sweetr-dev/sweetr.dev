...
<Steps>
  <Step title="Set up applications">
    Create [applications](/platform/applications) and configure their deployment settings.
  </Step>
  <Step title="Track deployments">
    Send deployments via the [API](/api-reference/create-deployment), PR merges, or GitHub deployment events.
  </Step>
  <Step title="Track incidents">
    Create [incidents](/platform/incidents) manually or enable [Incident Detection](/automations/incident-detection) to automate it.
  </Step>
</Steps>
